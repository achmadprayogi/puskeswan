        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('periksa/add_periksa')?>" class="btn btn-info float-right" role="button">Tambah Data</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            ?> 
                ...
                <tr>
                  ...
                  <td>
                      <a href="" id="detail" class="btn btn-success btn-xs"  data-toggle="modal" data-target="#modal-detail" 
                         data-pemilik_id="<?=$data->nama_pemilik?>"
                         ...
                         data-dokter="<?=$data_dokter1?>">
                         <i class="fa fa-eye" ></i> Detail</a></td>
                  <td>
                
                      <a href="<?=site_url('pemeriksaan/del/'.$data->id)?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda Yakin ?')"><i class="fa fa-trash" ></i> Hapus</a>
                  </td>
                </tr>
                <?php
              } ?>
