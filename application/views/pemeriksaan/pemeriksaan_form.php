    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="tanggal_periksa" class="form-control datetimepicker-input" data-target="#reservationdate"  value="<?php ini_set('date.timezone', 'Asia/Jakarta');
                  ...
                  <div class="form-group row">
                    <label for="pemilik_id" class="col-sm-2 col-form-label">Nama Pemilik</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                     ...
                     <input type="number" class="form-control-plaintext" readonly value="" name="telepon" id="telepon" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <label for="spesies" class="col-sm-2 col-form-label">Spesies</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                       <!-- <select class="form-control select2bs4" name="tanggal_lahir" id="tanggal_lahir" readonly style="width: 100%;">
                          
                        </select> -->
                        <input type="text" class="form-control-plaintext" readonly value="" name="tanggal_lahir" id="tanggal_lahir">
                    </div>
                    <div class="form-group row">
                    <div class="col-sm-9">
                        <input type="text" class="form-control-plaintext" readonly value="" name="umur" id="umur">
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <!-- <div class="form-check">
                          <input class="form-check-input" type="radio" id="dehidrasi" name="dehidrasi" value="Ya">
                          <label class="form-check-label">Ya</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="dehidrasi" name="dehidrasi" value="Tidak" >
                          <label class="form-check-label">Tidak</label>
                          <?php echo ($row->dehidrasi=='Tidak')?'checked':'' ?> -->
                        <!-- </div -->
                     ...
                     <select name="diagnosa" id="diagnosa" class="form-control select2bs4" style="width: 100%;">
                                  <option value=""  selected>- Pilih -</option>
                                    <?php foreach ($diagnosa->result() as $key => $data) { ?>
                                       <option value="<?=$data->name?>"<?=$data->diagnosa_id == $row->diagnosa_id ? "selected" : null?>><?=$data->name?></option>
                                    <?php }?>
                                 </select>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      ...
                      <!-- <div class="form-check">
                          <input class="form-check-input" type="radio" name="prognosa" id="prognosa" value="Fausta" >
                          <label class="form-check-label">Fausta</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="prognosa" id="infausta" value="Infausta">
                          <label class="form-check-label ">Infausta</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="prognosa" id="prognosa" value="Dubius">
                ...
                <div class="row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9"> 
                                 ...
                                 <select name="obat" id="obat" class="form-control select2bs4" style="width: 100%;">
                                  <option value=""  selected>- Pilih -</option>
                                    <?php foreach ($obat->result() as $key => $data) { ?>
                                       <option value="<?=$data->nama?>"<?=$data->obat_id == $row->obat_id ? "selected" : null?>><?=$data->nama?></option>
                                    <?php }?>
                                 </select>
                     ...
                     <input type="text" class="form-control" name="list_detail" id="list_detail" placeholder="Diagnosa">
                    </div>
                                 ...
                                 <select name="tindakan_id" id="tindakan_id" class="form-control select2bs4" style="width: 100%;">
                                  <option value=""  selected>- Pilih -</option>
                                    <?php foreach ($tindakan->result() as $key => $data) { ?>
                                       <option value="<?=$data->nama?>"<?=$data->tindakan_id == $row->tindakan_id ? "selected" : null?>><?=$data->nama?></option>
                                    <?php }?>
                                 </select>
                             <!--  <input type="text" name="obat" id="obat" size="50"> --> 
                            </td>
                                 ...
                                 <select name="resep_id" id="resep_id" class="form-control select2bs4" style="width: 100%;">
                                  <option value=""  selected>- Pilih -</option>
                                    <?php foreach ($resep->result() as $key => $data) { ?>
                                       <option value="<?=$data->nama?>"<?=$data->resep_id == $row->resep_id ? "selected" : null?>><?=$data->nama?></option>
                                    <?php }?>
                                 </select>
                             <!--  <input type="text" name="obat" id="obat" size="50"> --> 
                            </td>
              ...
              <div class="col-lg-10">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9"> 
                                 ...
                                 <select name="dokter_id" id="dokter_id" class="form-control select2bs4" style="width: 100%;">
                                  <option value=""  selected>- Pilih -</option>
                                    <?php foreach ($dokter->result() as $key => $data) { ?>
                                      <option value="<?=$data->nama_dokter?>"<?=$data->dokter_id == $row->dokter_id ? "selected" : null?>><?=$data->nama_dokter?></option>
                                   <?php }?>
                                 </select>
                            </td>        
                     ...
                     <input type="text" class="form-control" name="list_detail_dokter" id="list_detail_dokter" placeholder="Diagnosa">
                    </div>
         ...
         <!--    <div class="col-lg-10">
              <div class="form-group row">
                    <label for="dokter" class="col-sm-3 col-form-label">Dokter Yang Menangani</label>
                    <div class="col-sm-9">
                        <select multiple name="dokter[]" name="dokter" id="dokter" class="form-control select2bs4" style="width: 100%;">
                          
                          <?php foreach ($dokter->result() as $key => $data) { ?>
                            <option value="<?=$data->dokter_id?>"<?=$data->dokter_id == $row->dokter_id ? "selected" : null?>><?=$data->nama_dokter?></option>
                         <?php }?>
                        </select>
    ...
    <tbody>
       <tr>
                    ...
                    <tr>
                      ...
                      <td><span id="jenis_kelaminn"></span></td>
                    </tr>
                    <tr>
                      <th style="">Makan</th>
                      <td><span id="makann"></span></td>
                    </tr>
                    <tr>
                      <th style="">Minum</th>
                      <td><span id="minumm"></span></td>
                    </tr>
                    <tr>
                      <th style="">Muntah</th>
                      <td><span id="muntahh"></span></td>
                    </tr>
                    <tr>
                      <th style="">Diare</th>
                    ...
                    <tr>
                      <th style="">Vaksin</th>
                      <td><span id="vaksinn"></span></td>
                    </tr>
                    <tr>
                      <th style="">Obat Cacing</th>
                      <td><span id="obat_cacingg"></span></td>
                    </tr>
                    <tr>
                      <th style="">Lain-Lain</th>
                      <td><span id="lain_lainn"></span></td>
                    </tr>
                    <tr>
            ...
            <div class="modal-footer">
              ...
              <!--  <a href="#" id="submit" name="<?=$page?>" class="btn btn-success success">Simpans</a> -->
            </div>
        </div>
    </div>
</div>
  ...
  // ------------- add_detail_bantuan
    ...
    function render_tbl_detail1(){
      ...
      for(let i in list_detail_dokter){
        // console.log(list_detail[i]);
        str_list_detail_dokter += "<tr><td>"+i+"</td>"+
  ...
  // ------------- add_detail_bantuan
    ...
    function render_tbl_detail2(){
      ...
      for(let i in list_detail_tindakan){
        // console.log(list_detail[i]);
        str_list_detail_tindakan += "<tr><td>"+i+"</td>"+
  ...
  // ------------- add_detail_bantuan
    ...
    function render_tbl_detail4(){
      ...
      for(let i in list_obat_resep){
        ...
        str_list_obat_resep += "<tr><td>"+i+"</td>"+
    ...
    $('#submitBtn').click(function() {
       ...
       $('#pasienn').text($('#pasien_id').val());
       $('#spesiess').text($('#spesies').val());
       $('#jenis_kelaminn').text($('#jenis_kelamin').val());
       $('#makann').text($('#makan').val());
       $('#minumm').text($('#minum').val());
       $('#muntahh').text($('#muntah').val());
       $('#diaree').text($('#diare').val());
       $('#vaksinn').text($('#vaksin').val());
       $('#obat_cacingg').text($('#obat_cacing').val());
       $('#lain_lainn').text($('#lain_lain').val());
