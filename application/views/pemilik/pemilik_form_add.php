                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="text" name="telepon" class="form-control" value="<?=$row->telepon?>" id="inputEmail3" placeholder="Telepon">
                 ...
                 <!--  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="text" name="telepon" class="form-control" value="<?=$row->nama?>" placeholder="Telepon">
